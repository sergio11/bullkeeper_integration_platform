package es.bisite.usal.bullytect.rest;
...
import es.bisite.usal.bullytect.rest.response.IResponseCodeTypes;
import es.bisite.usal.bullytect.rest.response.ResponseStatus;
