...
public class LoadInitialDataForDevelopmentEnvironment implements CommandLineRunner {
    ...
    static {
        ...
        socialMedias.addAll(Arrays.asList( new SocialMediaEntity[] { 
            new SocialMediaEntity("EAACEdEose0cBAP7UZCVPtv7LSzbPFRlYZAPW3xpvhzOwvPelHyhP52cgMilkUZAe666aMHhfEYyUggLhwJlC8gCdYe9YZCIcG54ZAyyHOFmBQ21ZCjwDvvHYNrDNQYkK5It1MTU6ZBV7MWZC3QTIZAZAQgOMVpuR7r8b1DZBxgfcKRdIm8TFP1BXlHciTANGRurZAMLhnsdAzBa2zAZDZD", SocialMediaTypeEnum.FACEBOOK, sergio),
