...
public abstract class CommentEntityMapper {
    ...
    @Mappings({
        ...
        @Mapping(expression="java(sanchez.sanchez.sergio.bullkeeper.persistence.entity.SentimentLevelEnum.fromResult(commentEntity.getAnalysisResults().getSentiment().getResult()).name())",
        target = "sentiment"),
        @Mapping(expression="java(sanchez.sanchez.sergio.bullkeeper.persistence.entity.BullyingLevelEnum.fromResult(commentEntity.getAnalysisResults().getBullying().getResult()).name())",
        target = "bullying"),
        @Mapping(expression="java(sanchez.sanchez.sergio.bullkeeper.persistence.entity.DrugsLevelEnum.fromResult(commentEntity.getAnalysisResults().getDrugs().getResult()).name())",
        target = "drugs"),
        @Mapping(expression="java(sanchez.sanchez.sergio.bullkeeper.persistence.entity.ViolenceLevelEnum.fromResult(commentEntity.getAnalysisResults().getViolence().getResult()).name())",
        target = "violence"),
        @Mapping(expression="java(sanchez.sanchez.sergio.bullkeeper.persistence.entity.AdultLevelEnum.fromResult(commentEntity.getAnalysisResults().getAdult().getResult()).name())",
        target = "adult")
    })
