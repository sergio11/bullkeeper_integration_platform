...
public enum ConversationResponseEnum implements IResponseCodeTypes {
    ...
    ALL_CONVERSATION_FOR_SELF_USER_DELETED(1112L),
    ALL_CONVERSATION_FOR_MEMBER_DELETED(1113L),
    MEMBER_NOT_FOUND_EXCEPTION(1114L),
    SET_MESSAGES_AS_VIEWED_SUCCESSFULLY(1115L);
