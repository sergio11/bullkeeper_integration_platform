...
public enum AppsResponseCode implements IResponseCodeTypes{
    ...
    ALL_APP_RULES(1209L),
    APP_RULES_DETAIL(1210L),
    APPS_INSTALLED_DELETED(1211L),
    STATS_FOR_APPS_INSTALLED_IN_THE_TERMINAL(1212L),
    STATS_FOR_APP_INSTALLED(1213L),
    NO_APP_STATS_FOUND(1214L),
    APP_STATS_NOT_FOUND(1215L),
    APP_STATS_SAVED(1216L),
    STATS_FOR_APPS_INSTALLED_DELETED_SUCCESSFULLY(1217L),
    APP_DISABLED_SUCCESSFULLY(1218L),
    APP_ENABLED_SUCCESSFULLY(1219L);
