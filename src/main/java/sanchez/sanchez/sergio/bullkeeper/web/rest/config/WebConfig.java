package sanchez.sanchez.sergio.bullkeeper.web.rest.config;
...
import sanchez.sanchez.sergio.bullkeeper.fcm.utils.FCMErrorHandler;
import sanchez.sanchez.sergio.bullkeeper.web.rest.interceptor.HeaderRequestInterceptor;
...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addRedirectViewController("/documentation/v2/api-docs", "/v2/api-docs?group=bullkeeper");
