...
public final class AppModelEntity implements Serializable {
	...
	public AppModelEntity(String packageName, String category, String catKey, List<String> catKeys, Integer catType,
	...
	public void setPromoVide(String promoVide) {
		this.promoVideo = promoVide;
	}
	...
	public String toString() {
		return "AppModelEntity [packageName=" + packageName + ", category=" + category + ", catKey=" + catKey
