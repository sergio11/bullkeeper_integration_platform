...
public enum ParentResponseCode implements IResponseCodeTypes {
    ...
    EMAIL_ALREADY_EXISTS(437L), AUTHENTICATION_VIA_GOOGLE_SUCCESS(438L), WARNING_ALERTS_OF_SELF_PARENT_DELETED(439L),
    INFO_ALERTS_OF_SELF_PARENT_DELETED(440L), DANGER_ALERTS_OF_SELF_PARENT_DELETED(441L),
    SUCCESS_ALERTS_OF_SELF_PARENT_DELETED(442L);
