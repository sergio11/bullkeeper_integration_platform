...
public class TerminalErrorController  extends BaseController {
    ...
    @ResponseBody
    protected ResponseEntity<APIResponse<String>> handlerNoTerminalsFoundException(NoTerminalsFoundException noTerminalsFoundException, HttpServletRequest request){
