...
public enum AlertResponseCode implements IResponseCodeTypes {
    ...
    ALERT_CREATED(706L), CREATE_ALERT_FAILED(707L), ALL_SELF_ALERTS(708L), NO_NEW_ALERTS_FOUND(709L),
    ALERTS_STATISTICS(710L), NO_ALERTS_STATISTICS_FOR_THIS_PERIOD(711L);
