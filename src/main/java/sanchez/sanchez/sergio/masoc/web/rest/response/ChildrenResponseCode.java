...
public enum ChildrenResponseCode implements IResponseCodeTypes {
    ...
    SUCCESS_ALERTS_BY_SON(121L),
    WARNING_ALERTS_BY_SON(122L),
    INFO_ALERTS_BY_SON(123L), 
    DANGER_ALERTS_BY_SON(124L), 
    ...
    ALL_APPS_INSTALLED_IN_THE_TERMINAL(135L), 
    NO_APPS_INSTALLED_FOUND(136L),
    APPS_INSTALLED_SAVED(137L), 
    ALL_APPS_INSTALLED_DELETED(138L), 
    APP_INSTALLED_DELETED(139L), 
    APP_INSTALLED_NOT_FOUND(140L),
    NEW_APP_INSTALLED_ADDED(141L), 
    APP_RULES_WERE_APPLIED(142L), 
